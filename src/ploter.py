...
vtm = {"Dtree":[-1.0,-1.0,-1.0],"Rforest":[-1.0,-1.0,-1.0],"Nbayes":[-1.0,-1.0,-1.0],"Knn":[-1.0,-1.0,-1.0],"Svc":[-1.0,-1.0,-1.0]}
vf1 = {"Dtree":[-1.0,-1.0,-1.0],"Rforest":[-1.0,-1.0,-1.0],"Nbayes":[-1.0,-1.0,-1.0],"Knn":[-1.0,-1.0,-1.0],"Svc":[-1.0,-1.0,-1.0]}
vpr = {"Dtree":[-1.0,-1.0,-1.0],"Rforest":[-1.0,-1.0,-1.0],"Nbayes":[-1.0,-1.0,-1.0],"Knn":[-1.0,-1.0,-1.0],"Svc":[-1.0,-1.0,-1.0]}
vre = {"Dtree":[-1.0,-1.0,-1.0],"Rforest":[-1.0,-1.0,-1.0],"Nbayes":[-1.0,-1.0,-1.0],"Knn":[-1.0,-1.0,-1.0],"Svc":[-1.0,-1.0,-1.0]}
vac = {"Dtree":[-1.0,-1.0,-1.0],"Rforest":[-1.0,-1.0,-1.0],"Nbayes":[-1.0,-1.0,-1.0],"Knn":[-1.0,-1.0,-1.0],"Svc":[-1.0,-1.0,-1.0]}
vro = {"Dtree":[-1.0,-1.0,-1.0],"Rforest":[-1.0,-1.0,-1.0],"Nbayes":[-1.0,-1.0,-1.0],"Knn":[-1.0,-1.0,-1.0],"Svc":[-1.0,-1.0,-1.0]}
...
f.write(str(2) + ' PCA ' + str(vtm["Nbayes"][1]) + "\n")
f.write(str(3) + ' ICA ' + str(vtm["Nbayes"][2]) + "\n")
f.close()
...
f.write(str(2) + ' PCA ' + str(vpr["Nbayes"][1]) + "\n")
f.write(str(3) + ' ICA ' + str(vpr["Nbayes"][2]) + "\n")
f.close()
...
f.write(str(2) + ' PCA ' + str(vre["Nbayes"][1]) + "\n")
f.write(str(3) + ' ICA ' + str(vre["Nbayes"][2]) + "\n")
f.close()
...
f.write(str(2) + ' PCA ' + str(vf1["Nbayes"][1]) + "\n")
f.write(str(3) + ' ICA ' + str(vf1["Nbayes"][2]) + "\n")
f.close()
...
f.write(str(2) + ' PCA ' + str(vac["Nbayes"][1]) + "\n")
f.write(str(3) + ' ICA ' + str(vac["Nbayes"][2]) + "\n")
f.close()
...
f.write(str(2) + ' PCA ' + str(vro["Nbayes"][1]) + "\n")
f.write(str(3) + ' ICA ' + str(vro["Nbayes"][2]) + "\n")
f.close()
